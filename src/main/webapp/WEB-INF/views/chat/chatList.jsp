           ...
           <div class="container">
               <div class="row">
                   ...
                   <ul>
                       ...
                       <li><i class="fas fa-angle-double-right"></i> 고객상담</li>
                   </ul>
               </div>
           </div>
       </div>
               ...
               <div class="dest-row row">
                  ...
                  <c:if test="${!empty sessionScope.loginUser }">
                      <div class="col-lg-4 col-md-6">
                          <div class="dest-col">
                              <div class="dest-img">
                                  <img src="/resources/assets/images/destination/hotel.jpg" alt="">
                              </div>
                              <h3>예약 관련 문의</h3>
                              <a class="btn btn-outline-success" href="/chat/login1.do">바로가기</a>
                          </div>
                      </div>
                      <div class="col-lg-4 col-md-6">
                          <div class="dest-col">
                              <div class="dest-img">
                                  <img src="/resources/assets/images/destination/homepage.jpg" alt="">
                              </div>
                              <h3>홈페이지 이용 문의</h3>
                               <a class="btn btn-outline-success" href="/chat/login2.do">바로가기</a>
                          </div>
                      </div>
